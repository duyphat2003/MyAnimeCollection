package com.example.myanimecollection.viewmodel
...
import com.example.myanimecollection.data.TodoDatabase
...
class TodoViewModel(application: Application): AndroidViewModel(application) {
    ...
    {
        viewModelScope.launch { dao.insert(Todo(title = title)) }
    }

    fun toggleDone(todo: Todo){
        viewModelScope.launch { dao.update(todo.copy(isDone = !todo.isDone)) }
    }
